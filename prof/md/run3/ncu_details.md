...
This document summarizes a focused analysis of Nsight Compute results for [swizzle_xor.cu](kernels/swizzle_xor.cu) compared to [capacity.cu](kernels/capacity.cu).
...
![swizzle_xor - Bottlenecks](../../images/run3/swizzle_xor_bottlenecks.jpg)
...
![swizzle_xor - Throughput](../../images/run3/swizzle_xor_throughput.jpg)

![swizzle_xor - Throughput %](../../images/run3/swizzle_xor_throughput_p.jpg)

### Roofline

Both kernels remain strongly memory bound according to the roofline analysis.

![swizzle_xor - Roofline](../../images/run3/swizzle_xor_roofline.jpg)
...
![swizzle_xor - Compute Workload](../../images/run3/swizzle_xor_compute_workload.jpg)
...
![swizzle_xor - Memory Workload 1](../../images/run3/swizzle_xor_memory_workload_1.jpg)

![swizzle_xor - Memory Workload 2](../../images/run3/swizzle_xor_memory_workload_2.jpg)

Close-up on the DRAM throughput reduction:

![swizzle_xor - Memory Workload 3](../../images/run3/swizzle_xor_memory_workload_3.jpg)
...
![swizzle_xor - Scheduler Statistics](../../images/run3/swizzle_xor_scheduler_stats.jpg)

### Warp State Statistics

Warp cycle activity improved (warp cycles reduced ~50%), indicating better warp-level work distribution.

![swizzle_xor - Warp State Statistics](../../images/run3/swizzle_xor_warp_state_stats.jpg)
...
![swizzle_xor - Instruction Statistics](../../images/run3/swizzle_xor_warp_state_stats.jpg)

### Launch Statistics

No major changes in launch parameters other than a modest increase in register pressure.

![swizzle_xor - Launch Statistics](../../images/run3/swizzle_xor_launch_stats.jpg)
...
![swizzle_xor - GPU and Memory Workload](../../images/run3/swizzle_xor_gpu_and_memory_workload.jpg)
